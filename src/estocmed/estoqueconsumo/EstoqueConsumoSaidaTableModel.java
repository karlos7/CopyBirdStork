 ...
 * @author Adriano Lima
 */
public class EstoqueConsumoSaidaTableModel extends AbstractTableModel {

    private List<EstoqueConsumo> estoques = new ArrayList<>();
    private String[] colunas = {"Produto", "Qtd Estoque", "Qtd Saída", "Data Entrada", "Data Vencimento", "Tipo de Entrada"};

    public EstoqueConsumoSaidaTableModel(List<EstoqueConsumo> estoques) {
