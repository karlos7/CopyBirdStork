...
import estocmed.fornecedor.FornecedorTableModel;
 ...
 * @author Adriano Lima
 */
public class CadastroProdutoPermanente extends javax.swing.JDialog {
    ...
    public CadastroProdutoPermanente(java.awt.Frame parent, boolean modal, Usuario usuario) {
    ...
    private void initComponents() {
        ...
        txtFornecedor.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(100, 44, 143), 1, true));
        txtFornecedor.setMaximumSize(new java.awt.Dimension(8, 200));
        txtFornecedor.setMinimumSize(new java.awt.Dimension(8, 200));
        ...
        txtFornecedor.setBounds(60, 170, 450, 30);
        ...
        jLObrigatorioNome.setBounds(510, 160, 20, 30);
        ...
        btnFornecedor1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnFornecedor1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/birdpoint/imagens/add20-20.png"))); // NOI18N
        btnFornecedor1.setContentAreaFilled(false);
        btnFornecedor1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnFornecedor1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnFornecedor1.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnFornecedor1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnFornecedor1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnFornecedor1);
        btnFornecedor1.setBounds(520, 230, 30, 30);
        ...
        jlNomeUsuario1.setText("Fornecedor:");
        getContentPane().add(jlNomeUsuario1);
        jlNomeUsuario1.setBounds(60, 150, 100, 20);
        ...
        txtNomeProduto.setBounds(60, 110, 450, 30);
        ...
        jlNomeUsuario3.setBounds(60, 90, 150, 20);
        ...
        jLObrigatorioNome1.setBounds(510, 100, 20, 40);
        ...
        btnProduto2.setBounds(520, 170, 30, 30);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/birdpoint/imagens/CadastroProdutosPermanentes.png"))); // NOI18N
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        if (objetoRetorno != null) {
            ...
            txtFornecedor.setText(produtoPermanente.getFornecedor().getNome());
            txtNomeProduto.setText(produtoPermanente.getNomeProdutoPermanente());
            txtTipoProduto.setText(produtoPermanente.getTipoProduto().getTipoProduto());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        produtoPermanenteDAO.excluir(produtoPermanente);
        btLimparActionPerformed(null);
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (txtFornecedor.getText().equals("") || txtNomeProduto.getText().equals("") || txtTipoProduto.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Prencha todos os campos !!");
        } else {
            produtoPermanente.setNomeProdutoPermanente(txtNomeProduto.getText());
            if (produtoPermanente.getIdProdutoPermanente() == 0) {
                produtoPermanente.setFornecedor(fornecedor);
                produtoPermanente.setTipoProduto(tipoProduto);
            } else {
                produtoPermanente.setFornecedor(fornecedorDAO.consultarObjetoId("idFornecedor", produtoPermanente.getFornecedor().getIdFornecedor()));
                produtoPermanente.setTipoProduto(tipoProdutoDAO.consultarObjetoId("idTipoProduto", produtoPermanente.getTipoProduto().getIdTipoProduto()));

            }

            produtoPermanenteDAO.salvar(produtoPermanente);
    ...
    private void btnProduto2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProduto2ActionPerformed
        ...
        Object objetoRetorno = PesquisaGenerica.exibeTela(itm, "Fornecedor");
        if (objetoRetorno != null) {
            fornecedor = fornecedorDAO.consultarObjetoId("idFornecedor", objetoRetorno);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroProdutoPermanente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroProdutoPermanente dialog = new CadastroProdutoPermanente(new javax.swing.JFrame(), true, null);
