...
public class CadastroSaidaConsumo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jlSaida.setBounds(310, 130, 60, 30);
        ...
        jScrollPane1.setBounds(30, 160, 620, 170);
    ...
    private int quantidadeSaida(int index) {
        ...
        if (index == -1) {
            ...
            if (estoque.getQtdSaida() == 0) {
                ...
                if (estoque.getQtdSaida() != saidaEstoque.getEstoqueConsumo().get(index).getQtdSaida()) {
            ...
            if (objetoRetorno != null) {
                ...
                if (qtd != 0) {
                    if (index != -1) {
                        ...
                        if (verificaQuantidadeEstoque(qtd, 0)) {
